...
import combit.ListLabel24.DataProviders.ExecuteDbCommandEventArgs;
import jio.System.Data.OleDb.OleDbConnection;
import jio.System.EventHandler;
import jio.System.IntPtr;
import jio.System.Windows.Forms.DockStyle;
import jio.System.Data.OleDb.OleDbCommand;
...
public class Form1 extends JFrame {
    ...
    public Form1() throws Exception {
        ...
        LLPreviewControl.addButtonPress(new ButtonPressHandler() {
            @Override
            public void Invoke(Object sender, ButtonPressEventArgs e) {
    ...
    private void initializeComponents() throws Exception {
        ...
        this.LLPreviewControl.setBackColor(jio.System.Drawing.Color.getWhite());
...
//        this.LLPreviewControl.setText("listLabelPreviewControl");
    ...
    private DbCommandSetDataProvider CreateDbCommandSetDataProvider() {
        ...
        provider.addExecuteDbCommand(new EventHandler<ExecuteDbCommandEventArgs>() {
            @Override
            public void Invoke(Object sender, ExecuteDbCommandEventArgs e) {
                OleDbCommand command = (OleDbCommand) e.getCommand();
    ...
    public void ExecuteDbCommand(ExecuteDbCommandEventArgs args) {
        OleDbCommand command = (OleDbCommand) args.getCommand();
...
//        try {
            ...
            // call the designer
            IntPtr windowHandle = new IntPtr(combit.WinHelper.getWindowHandle(this));
            workingLL.getCore().setParentHandle(windowHandle);
            workingLL.Design();
...
//            JOptionPane.showMessageDialog(null,
//                    "Information: " + LlException.toString()
...
//        }
    ...
    public static void main(String[] args) {
    	...
    	Common.Activation.initializeJavonet();
